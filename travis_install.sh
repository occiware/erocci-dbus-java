...
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.infrastructure_0.1.0.201602051536.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.infrastructure" -Dversion="0.1.0.201602051536" -Dpackaging=jar
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.docker_0.1.0.201602051536.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.docker" -Dversion="0.1.0.201602051536" -Dpackaging=jar
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.docker.connector_0.1.0.201602051536.jar"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.docker.connector" -Dversion="0.1.0.201602051536" -Dpackaging=jar
