...
mvn install:install-file -Dfile="./lib/org.occiware.clouddesigner.occi.infrastructure.connector.dummy-0.1.0-SNAPSHOT"  -DgroupId="Clouddesigner" -DartifactId="org.occiware.clouddesigner.occi.infrastructure.connector.dummy" -Dversion="0.1.0-SNAPSHOT" -Dpackaging=jar
